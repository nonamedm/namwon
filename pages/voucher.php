        ...
        <div class="col-lg-6 ks4 voucher2">
			...
			<li class="media">
				<div class="media-body">
							...
							<div data-testid="svgRoot-comp-l76zs02v" class="_3bLYT _2OIRR">
								<svg preserveAspectRatio="xMidYMid meet" data-bbox="54.5 49 91 102.001" viewBox="54.5 49 91 102.001" height="25" width="25" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true">
									<g>
										...
										<path d="M142.135 49h-84.27a3.365 3.365 0 0 0-3.365 3.366v95.269a3.365 3.365 0 0 0 3.365 3.366h84.27a3.365 3.365 0 0 0 3.365-3.366V52.366A3.365 3.365 0 0 0 142.135 49zm-3.365 95.269H61.23V55.731h77.54v88.538z" fill="#0E4828" data-color="2"></path>
										<path d="M67.696 129.67h64.609a2.02 2.02 0 0 0 2.019-2.019v-64.62a2.018 2.018 0 0 0-2.019-2.019H67.696a2.02 2.02 0 0 0-2.019 2.019v64.62c0 1.116.904 2.019 2.019 2.019zm2.019-64.62h60.571v60.581H69.715V65.05z" fill="#0E4828" data-color="2"></path>
									</g>
								</svg>
							</div>
						</div>
					...
					<p class="ks3">
						<a href="#submitAct" style="padding: 10px 20px 10px 20px;background-color: #007bff;color: white;">신청하기</a>
					</p>
				</div>
			</li>
			</ul>
